# Analysing the Wahl-O-Mat about the 2017 German federal election
...
Figures 4 and 5 showshow the "political map" has changed since the 2013 federal election.

![alt text](animation.gif "Figure 4")

![alt text](finalframe.png "Figure 5")
